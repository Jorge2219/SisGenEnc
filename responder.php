...
<body>
    <div class="container mt-4">
        ...
        <form id="formEncuesta">
            ...
            <div class="jumbotron">
                <h3>Comentarios</h3>
                <textarea class="form-control" rows="4" name="comentario" placeholder="Escribe tus comentarios aquí"></textarea>
            </div>

            <!-- Botones de enviar y cancelar -->
            <div class="row mb-2">
                <div class="col-md-6 text-right">
                    <button type="button" id="btnEnviar" class="btn btn-custom">Enviar</button>
                </div>
    ...
    $(document).ready(function() {
        ...
        $('#btnEnviar').click(function() {
            ...
            $('input[type=radio]:checked').each(function() {
                respuestas.push({
                    pregunta_id: $(this).attr('name').split('_')[1],
                    respuesta: $(this).val()
                });
            });
            ...
            $.ajax({
                ...
                error: function() {
                    Swal.fire({
                        title: 'Error',
                        text: 'Hubo un error al enviar tus respuestas. Intenta de nuevo más tarde.',
                        icon: 'error'
                    });
                }
            });
