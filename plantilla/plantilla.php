    ...
    <div class="container mt-4">
        ...
        <div class="row mb-4">
            <div class="col text-center">
                <input type="text" id="tituloInput" class="form-control title" placeholder="Ingrese el título">
            </div>
        </div>
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="campoPeriodo" class="form-control" placeholder="P. ej. 2024-2"></td>
                        </tr>
        ...
        <div class="col text-center">
            <p id="descripcion" class="form-control" style="border: none; box-shadow: none;">
                en una escala donde 1 <input type="text" class="inline-input" placeholder="1"> es "completamente en desacuerdo" 
                y <input type="text"  class="inline-input" placeholder="3"> es "completamente de acuerdo". ¿como calificarías los siguientes puntos?
            </p>
        </div>
    </div>
        <!-- Tabla principal -->
